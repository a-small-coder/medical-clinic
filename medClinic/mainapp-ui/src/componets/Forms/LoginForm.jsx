                    ...
                    return (
                        <Form className="authForm loginForm">
                            <div className="authForm__form">
                                ...
                                />
                                <Link to="/restore-password" className="authForm__password-link  _text-link _icon-search">
                                    <span>Забыли пароль?</span>
                                </Link>
                                
                                <Link to="/user-manual" className="authForm__user-manual  _text-link">
                                    <span>Руководство пользователя</span>
                                </Link>
                            </div>
                            <ButtonsBlock isFormValid={formik.isValid} wrapperClass={"authForm__button-block"} formType={"login"}/>
                        </Form>
                    )
                }
            }
